...
- [ ] Create a Cargo Registration with cargo details
- [ ] Ensure service item is set for each cargo detail
- [ ] Create and submit a Manifest linked to the cargo
- [ ] Open a Sales Invoice
- [ ] Select the same customer
- [ ] Click "Get Items From" → "Cargo Registrations"
- [ ] Verify cargo details appear in the dialog
- [ ] Verify truck details from Manifest are shown
- [ ] Select cargo details and add to invoice
- [ ] Verify invoice items have correct descriptions
- [ ] Submit the invoice
- [ ] Try fetching again - those cargo details should not appear
- [ ] Cancel the invoice
- [ ] Try fetching again - those cargo details should reappear

## Troubleshooting

### Button Not Showing

- Ensure customer and company are selected
- Ensure invoice is in draft status (not submitted)
- Clear browser cache and refresh

### No Cargo Details Appearing

- Verify cargo registrations are submitted
- Verify cargo details have not been invoiced yet
- Verify customer matches
- Check that cargo details have service items set

### Truck Details Not Showing

- Ensure cargo details are assigned to a Manifest
- Ensure Manifest is submitted
- Verify Manifest has truck details filled in
...
- Export cargo details to Excel

## Support

For issues or questions, contact: info@vvsdtz.com
