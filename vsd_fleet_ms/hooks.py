...
doctype_js = {"Sales Invoice": "custom/sales_invoice_custom.js"}
...
doc_events = {
    "Sales Invoice": {
        "on_cancel": "vsd_fleet_ms.custom.sales_invoice_customization.update_cargo_detail_on_invoice_cancel"
    }
}
